...
import library_project.Searchclass2;

public class searchbook 
{
	public	String subject,substring;
	private Searchclass2 s=new Searchclass2();
	private Searchclass2 s2=new Searchclass2();
	private Searchclass2 s3=new Searchclass2();
	private Searchclass2 s4=new Searchclass2();
	private Searchclass2 s5=new Searchclass2();
	private Searchclass2 s6=new Searchclass2();
	private Searchclass2 s7=new Searchclass2();
	public String str1;
	public String str2;
	public String str3;
	public String str4;
	...
	public  static ProductionCode2 Book=null;
	public  static addBookSteps addingBook=null;
	public searchbook()
	{
	    Book=new ProductionCode2();
	    addingBook=new addBookSteps(Book); 
	    addingBook.the_administrator_is_logged_in();
	    addingBook.the_administrator_add_a_book_to_the_library();
	}
